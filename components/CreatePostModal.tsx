...
export default function CreatePostModal({
  ...
  const toolbarBtn = (
    ...
    <button
      ...
      className={`w-7 h-7 rounded-md hover:bg-gray-100 flex items-center justify-center text-gray-800 transition-colors text-xs ${extra}`}
    >
      {display}
    </button>
  );
  ...
  const mediaToolBtn = (
    ...
    <button
      ...
      onClick={onClick}
      className={`w-7 h-7 rounded-md border border-gray-200 hover:bg-gray-100 flex items-center justify-center bg-white shadow-sm transition-colors text-xs ${color}`}
    >
      {icon}
    </button>
  );
  ...
  const mediaButtons = (
    <>
      ...
      {mediaToolBtn("Create Event", <Calendar className="w-3.5 h-3.5" />, () =>
  ...
  const generateImageToolbarBtn = (
    <button
      ...
      className="ml-auto inline-flex items-center gap-1 px-2.5 py-1 rounded-md border border-purple-300 bg-white text-purple-600 hover:bg-purple-50 shadow-sm transition-colors text-xs font-medium disabled:opacity-50"
    >
      {imageGenLoading ? (
                    ...
                    <div className="min-h-[52px] px-2 py-1.5 border-t border-gray-200 bg-white flex items-center gap-1 flex-wrap">
                      {showTextToolbar ? (
                        <>
                          ...
                          {editorToolBtn("Redo", <Redo2 className="w-3.5 h-3.5" />, () => {
                          ...
                          <div className="w-px h-6 bg-gray-300 mx-0.5" />
                          {toolbarBtn("link", "Link", <Link2 className="w-3.5 h-3.5" />)}
                          {editorToolBtn("Divider", <Minus className="w-3.5 h-3.5" />, () =>
